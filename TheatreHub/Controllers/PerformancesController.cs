...
namespace TheatreHub.Controllers
{
    public class PerformancesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Description,Genre,PremiereDate,DurationMinutes,Status,CreatedAt")] Performance performance)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Description,Genre,PremiereDate,DurationMinutes,Status,CreatedAt")] Performance performance)
        {
